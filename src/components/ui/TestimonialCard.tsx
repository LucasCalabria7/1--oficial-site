...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <motion.div 
      className="bg-white rounded-lg p-6 flex flex-col h-full border border-primary-700/20 shadow-[0_4px_20px_-4px_rgba(5,20,115,0.2)]"
      whileHover={{ y: -5, boxShadow: '0 8px 30px -6px rgba(5,20,115,0.25)' }}
    ...
    >
      ...
      <div className="flex items-center mt-4">
        ...
        />
        <div>
          <p className="font-semibold text-primary-700">{name}</p>
